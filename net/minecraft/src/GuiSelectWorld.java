...
public class GuiSelectWorld extends GuiScreen
{
    ...
    /** resize world button **/
    private GuiButton buttonResize;
    ...
    public void initButtons()
    {
        ...
        controlList.add(buttonDelete = new GuiButton(6, width / 2 - 154, height - 28, 46, 20, stringtranslate.translateKey("selectWorld.rename")));
        controlList.add(buttonRename = new GuiButton(2, width / 2 - 102, height - 28, 46, 20, stringtranslate.translateKey("selectWorld.delete")));
        controlList.add(buttonResize = new GuiButton(7, width / 2 - 50, height - 28, 46, 20, stringtranslate.translateKey("Resize")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        	mc.displayGuiScreen(new GuiResizeWorld(this, getSaveFileName(selectedWorld)));
        }
    ...
    static GuiButton getResizeButton(GuiSelectWorld parentWorldGui) {
		return parentWorldGui.buttonResize;
	}
