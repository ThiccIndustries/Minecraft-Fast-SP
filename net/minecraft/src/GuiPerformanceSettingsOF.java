...
public class GuiPerformanceSettingsOF extends GuiScreen
{
    ...
    private String[] getTooltipLines(String s)
    {
    	...
    	if(s.equals("Random Ticks")){
            return (new String[]
                    {
                        "Disable random ticks",
                        "  OFF - No crop grow, leaf decay, etc (fast)",
                        "  ON  - Randomly tick chunks - Vanilla gameplay (slow)",
                    });
    	}
    ...
    static
    {
        enumOptions = (new EnumOptions[]
                {
                    EnumOptions.ENTITY_DISTANCE, EnumOptions.RANDOM_UPDATES, EnumOptions.PRELOAD_TEXTURES, EnumOptions.SMOOTH_FPS, EnumOptions.SMOOTH_INPUT, EnumOptions.LOAD_FAR, EnumOptions.PRELOADED_CHUNKS, EnumOptions.CHUNK_UPDATES,
