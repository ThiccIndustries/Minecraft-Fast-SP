...
public abstract class EntityLiving extends Entity
{
    ...
    public void setAttackTarget(EntityLiving par1EntityLiving)
    {
        ...
        {
            Reflector.callVoid(90, new Object[]
                    {
    ...
    public void onUpdate()
    {
        if (Reflector.hasClass(9))
        {
            boolean flag = Reflector.callBoolean(91, new Object[]
                    {
                        this
                    });
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        if (Reflector.hasClass(9))
        {
            boolean flag = Reflector.callBoolean(92, new Object[]
                    {
                        this, par1DamageSource, Integer.valueOf(par2)
                    });
    ...
    protected void damageEntity(DamageSource par1DamageSource, int par2)
    {
        if (Reflector.hasClass(9))
        {
            par2 = Reflector.callInt(93, new Object[]
                    {
                        this, par1DamageSource, Integer.valueOf(par2)
                    });
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        if (Reflector.hasClass(9))
        {
            boolean flag = Reflector.callBoolean(94, new Object[]
                    {
                        this, par1DamageSource
                    });
        ...
        if (!worldObj.isRemote)
        {
            ...
            if (Reflector.hasClass(9))
            {
                ...
                list = (List)Reflector.getFieldValue(this, 101);
                Reflector.callVoid(list, 110, null);
            }
            ...
            if (Reflector.hasClass(9))
            {
                ...
                Reflector.callVoid(95, new Object[]
                        {
                            this, par1DamageSource, list, Integer.valueOf(i), Boolean.valueOf(recentlyHit > 0), Integer.valueOf(j)
                        });
                EntityItem entityitem;

                for (Iterator iterator = list.iterator(); iterator.hasNext(); worldObj.spawnEntityInWorld(entityitem))
                {
    ...
    protected void fall(float par1)
    {
        if (Reflector.hasClass(9))
        {
            boolean flag = Reflector.callBoolean(96, new Object[]
                    {
                        this, Float.valueOf(par1)
                    });
    ...
    protected void jump()
    {
        ...
        if (Reflector.hasClass(9))
        {
            Reflector.callVoid(97, new Object[]
                    {
                        this
                    });
        }
