...
public class World implements IBlockAccess
{
     ...
     */
    public void saveWorld(boolean par1, boolean drop, IProgressUpdate par2IProgressUpdate)
    {
        ...
        chunkProvider.saveChunks(par1, drop, par2IProgressUpdate);
    }
    ...
    public boolean quickSaveWorld(int par1)
    {
        ...
        return chunkProvider.saveChunks(false, false, null);
    }
    ...
    public void updateEntities()
    {
        ...
        for (int l = 0; l < loadedEntityList.size(); l++)
        {
            ...
            int entitydx = (int)entity2.posX - playerx;
            int entitydy = (int)entity2.posY - playery;
            int entitydz = (int)entity2.posZ - playerz;
            
            if(entitydx > distance || entitydx < -distance){
            	entity2.setVelocity(0, 0, 0);
            	continue;
            }
            if(entitydy > distance || entitydy < -distance){
            	entity2.setVelocity(0, 0, 0);
            	continue;
            }
            if(entitydz > distance || entitydz < -distance){
            	entity2.setVelocity(0, 0, 0);
            	continue;
            }
    ...
    public void saveWorldIndirectly(IProgressUpdate par1IProgressUpdate, boolean drop)
    {
        saveWorld(true, drop, par1IProgressUpdate);
    ...
    {	
    	if(GameSettings.active.randomUpdateDistance == 0)
    		return;
        ...
        int distance = GameSettings.active.randomUpdateDistance;
